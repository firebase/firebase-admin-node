...
gulp.task('removeAutogeneratedTypings', function() {
...
// Build typings
gulp.task('build_typings', gulp.series('cleanup', 'compile_autogen_typing', 'copyTypings', 'removeAutogeneratedTypings')); // , 'copyTypings'));
