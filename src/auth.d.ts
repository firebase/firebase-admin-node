...
interface UserRecord {
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/Auth#listUsers `listUsers()`}.
   *
   */
  passwordHash?: string;
   ...
   * This is set via
   * {@link https://firebase.google.com/docs/reference/admin/node/Auth#setCustomUserClaims `setCustomUserClaims()`}
   */
   ...
   * from the {@link https://firebase.google.com/docs/reference/admin/node/Auth#revokeRefreshTokens `revokeRefreshTokens()`}
 ...
 * {@link https://firebase.google.com/docs/reference/admin/node/Auth#verifyIdToken `verifyIdToken()`} method.
 *
...
/** Represents the result of the {@link getUsers()} API. */
 ...
 * {@link https://firebase.google.com/docs/reference/admin/node/Auth#listUsers `listUsers()`} operation. Contains the list
 * of users for the current batch and the next page token if available.
 */
interface ListUsersResult {

  /**
   * The list of {@link UserRecord `UserRecord`} objects for the
...
/**
 * Interface representing the object returned from a
 * {@link https://firebase.google.com/docs/reference/admin/node/Auth#listTenants `listTenants()`}
 * operation.
...
interface ListTenantsResult {
  ...
  /**
   * The list of {@link Tenant `Tenant`} objects for the downloaded batch.
   */
  tenants: Tenant[];
 ...
 * {@link https://firebase.google.com/docs/reference/admin/node/Auth#listProviderConfigs `listProviderConfigs()`}.
 */
 ...
 * {@link https://firebase.google.com/docs/reference/admin/node/Auth#createProviderConfig `createProviderConfig()`}.
 */
 ...
 * {@link https://firebase.google.com/docs/reference/admin/node/Auth#updateProviderConfig `updateProviderConfig()`}.
 */
...
interface BaseAuth {
   ...
   * {@link UserRecord#tokensValidAfterTime `tokensValidAfterTime`} to
   ...
   * {@link Auth#verifyIdToken `verifyIdToken(idToken, true)`}
  ...
  */
   ...
   * optional  {@link ActionCodeSettings `ActionCodeSettings`} object
   ...
   * {@link ActionCodeSettings `ActionCodeSettings`} object provided
