...
/**
 * Interface representing a TOTP user-enrolled second factor
*  for a `CreateRequest`.
 */
export interface CreateTotpMultiFactorInfoRequest extends BaseCreateMultiFactorInfoRequest {

  /**
   * The shared secret key associated with a TOTP second factor.
   */
