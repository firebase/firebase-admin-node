...
import { TenantAwareAuth, GetUsersResult, ListUsersResult, DeleteUsersResult, DecodedIdToken, SessionCookieOptions } from './auth';
 ...
 */
export class BaseAuthImpl<T extends AbstractAuthRequestHandler> {
 ...
 */
export class TenantAwareAuthImpl extends BaseAuthImpl<TenantAwareAuthRequestHandler> implements TenantAwareAuth {
 ...
 */
export class AuthImpl extends BaseAuthImpl<AuthRequestHandler> implements FirebaseServiceInterface {
