 ...
 */
export class TenantImpl implements Tenant {
  ...
  public static buildServerRequest(
    ...
    TenantImpl.validate(tenantOptions, createRequest);
  ...
  constructor(response: any) {
    const tenantId = TenantImpl.getTenantIdFromResourceName(response.name);
    if (!tenantId) {
      throw new FirebaseAuthError(
