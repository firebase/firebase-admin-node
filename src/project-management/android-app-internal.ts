...
export class AndroidAppImpl implements AndroidApp {
    ...
    return this.requestHandler.getAndroidShaCertificates(this.resourceName)
      .then((responseData: any) => {
        ...
        return responseData.certificates.map((certificateJson: any) => {
          ...
          return new ShaCertificateImpl(certificateJson.shaHash, certificateJson.name);
        });
      });
  }
...
export class ShaCertificateImpl implements ShaCertificate {
