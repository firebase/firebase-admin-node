...
import { AndroidAppImpl, ShaCertificateImpl } from './android-app-internal';
import { IosAppImpl } from './ios-app-internal';
 ...
 */
export class ProjectManagementImpl implements ProjectManagement, FirebaseServiceInterface {
  ...
  public androidApp(appId: string): AndroidApp {
    return new AndroidAppImpl(appId, this.requestHandler);
  }
  ...
  public iosApp(appId: string): IosApp {
    return new IosAppImpl(appId, this.requestHandler);
  }
  ...
  public shaCertificate(shaHash: string): ShaCertificate {
    return new ShaCertificateImpl(shaHash);
  }
  ...
  public createAndroidApp(packageName: string, displayName?: string): Promise<AndroidApp> {
    return this.getResourceName()
      ...
      .then((responseData: any) => {
        ...
        return new AndroidAppImpl(responseData.appId, this.requestHandler);
      });
  }
  ...
  public createIosApp(bundleId: string, displayName?: string): Promise<IosApp> {
    return this.getResourceName()
      ...
      .then((responseData: any) => {
        ...
        return new IosAppImpl(responseData.appId, this.requestHandler);
      });
  }
    ...
    return this.getResourceName()
      ...
      .then((responseData: any) => {
        ...
        return responseData.apps.map((appJson: any) => {
          ...
          if (platform === 'android') {
            return new AndroidAppImpl(appJson.appId, this.requestHandler);
          } else {
            return new IosAppImpl(appJson.appId, this.requestHandler);
          }
        });
      });
  }
