...
export {
  ...
  ServerConfig as RemoteConfigServerConfig,
  ServerTemplate as RemoteConfigServerTemplate,
  ServerTemplateData as RemoteConfigServerTemplateData,
  ServerTemplateOptions as RemoteConfigServerTemplateOptions,
  RemoteConfigUser,
  TagColor,
  Version,
