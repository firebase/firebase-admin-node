...
describe('Firestore', () => {
  ...
  describe('Initializer', () => {
    ...
    it('should throw given an invalid credential with project ID', () => {
      ...
      expect(() => {
        return firestore(mockCredentialApp);
  ...
  describe('app', () => {
    it('returns the app from the constructor', () => {
      ...
      expect(firestoreInstance.app).to.equal(mockApp);
    });

    it('is read-only', () => {
      expect(() => {
        firestoreInstance.app = mockApp;
  ...
  describe('client', () => {
    it('returns the client from the constructor', () => {
      // We expect referential equality here
      expect(firestoreInstance.client).to.not.be.null;
    });

    it('is read-only', () => {
      expect(() => {
        firestoreInstance.client = mockApp;
