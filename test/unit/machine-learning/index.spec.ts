...
import { getMachineLearning, MachineLearning } from '../../../src/machine-learning/index';
...
describe('MachineLearning', () => {
  ...
  describe('getMachineLearning()', () => {
    ...
    it('should reject given an invalid credential without project ID', () => {
      ...
      const client = getMachineLearning(mockCredentialApp);
      return client.getModel('test')
        .should.eventually.rejectedWith(noProjectIdError);
    });

    it('should not throw given a valid app', () => {
      expect(() => {
        return getMachineLearning(mockApp);
      }).not.to.throw();
    });

    it('should return the same instance for a given app instance', () => {
      const client1: MachineLearning = getMachineLearning(mockApp);
      const client2: MachineLearning = getMachineLearning(mockApp);
