...
describe('MachineLearning', () => {
  ...
  const AUTOML_MODEL_NAME = 'automlModel123';
  ...
  describe('Model', () => {
    it('should successfully construct a gcs tflite model', () => {
      ...
      expect(tflite.automlModel).not.to.exist;
    ...
    it('should successfully construct an autoML model', () => {
      ...
      expect(tflite.automlModel).to.be.equal('automlModel123');
