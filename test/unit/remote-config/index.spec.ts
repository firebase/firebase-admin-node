...
import { getRemoteConfig, RemoteConfig } from '../../../src/remote-config/index';
...
describe('RemoteConfig', () => {
  ...
  describe('getRemoteConfig()', () => {
    ...
    it('should reject given an invalid credential without project ID', () => {
      ...
      const remoteConfig = getRemoteConfig(mockCredentialApp);
    ...
    it('should not throw given a valid app', () => {
      expect(() => {
        return getRemoteConfig(mockApp);
      }).not.to.throw();
    });

    it('should return the same instance for a given app instance', () => {
      const rc1: RemoteConfig = getRemoteConfig(mockApp);
      const rc2: RemoteConfig = getRemoteConfig(mockApp);
